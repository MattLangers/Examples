<script lang="ts">
	...
	var editProduct = async function (product: Product): Promise<boolean> {
		productEdit = new ProductEditObjectBuilder().create(product, { id: product.id, productType: product.productType ,name: productName, description: productDescription, ranking: productRanking, price: productPrice });
				...
				>
							...
							<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left grow">
								<div class="form-group mb-6">
									...
									<textarea
										...
										rows="4"
										bind:value={productDescription}></textarea
									>
					...
					<div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
						<button
							...
							on:click={handleEdit}>Submit</button
						>
						<button
							type="button"
