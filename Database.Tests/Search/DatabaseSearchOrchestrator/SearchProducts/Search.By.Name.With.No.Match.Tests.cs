...
{
    public class DatabaseSearchOrchestrator_SearchProducts_By_Name_With_No_Match_Tests
    {
        ...
        public void Setup()
        {
            ...
            autoMocker.GetMock<IProductsToDtoMapper>().Setup(m => m.Map(It.Is<IQueryable<Product>>(m => m.Count() == 0))).Returns(expectedResult);
